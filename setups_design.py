...
methods_config = {
    ...
    "PbP.Fixed": {"label": "PbP", "color": color_palette[7], "linestyle": "-", "marker":"o"},
    ...
    "MICE.10.IMP.M": {"label": "MICE.10.IMP.M", "color": color_palette[4], "linestyle": ":", "marker":"^"},
    "MICE.10.Y.IMP.M": {"label": "MICE.10.Y.IMP.M", "color": color_palette[1], "linestyle": ":", "marker":"^"},
    "MICE.10.M.IMP.M": {"label": "MICE.10.M.IMP.M", "color": color_palette[8], "linestyle": ":", "marker":"^"},
    "MICE.10.Y.M.IMP.M": {"label": "MICE.10.Y.M.IMP.M", "color": color_palette[2], "linestyle": ":", "marker":"^"},
    ...
    "MICE.RF.10.IMP": {"label": "MICE.RF.10.IMP", "color": color_palette[4], "linestyle": "-", "marker":"o"},
    "MICE.RF.10.Y.IMP": {"label": "MICE.RF.10.Y.IMP", "color": color_palette[1], "linestyle": "-", "marker":"o"},
    "MICE.RF.10.M.IMP": {"label": "MICE.RF.10.M.IMP", "color": color_palette[8], "linestyle": "-", "marker":"o"},
    "MICE.RF.10.Y.M.IMP": {"label": "MICE.RF.10.Y.M.IMP", "color": color_palette[2], "linestyle": "-", "marker":"o"},

    "MICE.RF.10.IMP.M": {"label": "MICE.RF.10.IMP.M", "color": color_palette[3], "linestyle": "--", "marker":"x"},
    "MICE.RF.10.Y.IMP.M": {"label": "MICE.RF.10.Y.IMP.M", "color": color_palette[5], "linestyle": "--", "marker":"x"},
    "MICE.RF.10.M.IMP.M": {"label": "MICE.RF.10.M.IMP.M", "color": color_palette[6], "linestyle": "--", "marker":"x"},
    "MICE.RF.10.Y.M.IMP.M": {"label": "MICE.RF.10.Y.M.IMP.M", "color": color_palette[7], "linestyle": "--", "marker":"x"},
