## Codebase from the paper "When Pattern-by-Pattern Works: Theoretical and Empirical Insights for Logistic Models with Missing Values" ([arxiv](https://arxiv.org/abs/2507.13024))
