...
fig, axes = plt.subplots(1, len(scores_sel), figsize=(4 * len(scores_sel), 7)) # default is 4 * len, 5
...
plt.tight_layout()
# plt.savefig(os.path.join("plots_scripts", "plots", "SimA_SingleImputation.pdf"))
plt.savefig(os.path.join("plots_scripts", "plots", "SimA_SelectedProcedures_Brier_Angular.pdf"))
...
plt.savefig(os.path.join("plots_scripts", "plots", "SimA_SelectedProcedures_per_pattern.pdf"))
plt.show()
...
plt.tight_layout()
plt.savefig(os.path.join("plots_scripts", "pwp", "SimA_MAE.pdf"))
plt.show()
...
plt.tight_layout()
plt.savefig(os.path.join("plots_scripts", "pwp", "SimA_other.pdf"))
plt.show()
